...
# @TODO Define a function that implements the following user story:
# As a lender,
# I want to filter the bank list by checking if the customer's debt-to-income is equal or less than the maximum debt-to-income ratio allowed by the bank
